...
export class AutoCorrector {
  ...
  async saveSessionResults(uploadId, filename, processedRows) {
    ...
    await this.pool.query(
      `
        INSERT INTO upload_quality_log (upload_id, total_rows, auto_fixed, fuzzy_fixed, flagged)
        VALUES ($1, $2, $3, $4, $5)
      `,
      [uploadId, processedRows, this.session.autoFixed, this.session.fuzzyFixed, this.session.flagged]
    )
  }
